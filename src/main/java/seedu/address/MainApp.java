...
import seedu.address.storage.WordBankStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        WordBankStorage wordBankStorage = new JsonWordBankStorage(
            userPrefs.getAddressBookFilePath());
        storage = new StorageManager(wordBankStorage, userPrefsStorage);
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning(
                "Data file not in the correct format. Will be starting with an empty WordBank");
            initialData = new WordBank();
        } catch (IOException e) {
            logger.warning(
                "Problem while reading from the file. Will be starting with an empty WordBank");
            initialData = new WordBank();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting WordBank " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logic.doCleanup(); // some clean up operations
        logger.info(
