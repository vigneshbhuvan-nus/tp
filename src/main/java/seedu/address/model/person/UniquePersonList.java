 ...
 * A person is considered unique by comparing using {@code Entry#isSamePerson(Entry)}. As such, adding and updating of
 * persons uses Entry#isSamePerson(Entry) for equality so as to ensure that the person being added or updated is
 * unique in terms of identity in the UniquePersonList. However, the removal of a person uses Entry#equals(Object) so
...
public class UniquePersonList implements Iterable<Entry> {
     ...
     */
    private boolean personsAreUnique(List<Entry> persons) {
